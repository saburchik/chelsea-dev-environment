...
exports.isObject = exports.nonFinite = exports.step = exports.now = exports.modifyPrototypes = exports.original = exports.isScrollBehaviorSupported = void 0;
const ease = (k) => {
    return 0.5 * (1 - Math.cos(Math.PI * k));
};
const DURATION = 500;
exports.isScrollBehaviorSupported = () => "scrollBehavior" in document.documentElement.style;
exports.original = {
...
exports.modifyPrototypes = (modification) => {
...
exports.now = () => { var _a, _b, _c; return (_c = (_b = (_a = window.performance) === null || _a === void 0 ? void 0 : _a.now) === null || _b === void 0 ? void 0 : _b.call(_a)) !== null && _c !== void 0 ? _c : Date.now(); };
exports.step = (context) => {
    const currentTime = exports.now();
